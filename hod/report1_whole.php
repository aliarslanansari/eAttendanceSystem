...
/*		$sub_code=substr($sub_det,0,5);
 ...
 $query1 = "select attendance from attendance where branch='$branch' and year='$year' and shift='$shift' and head='TH' and date between '$startdate' and '$enddate' order by ID";
 ...
 $query2 = "select attendance from attendance where branch='$branch' and year='$year' and shift='$shift' and head='PR' and date between '$startdate' and '$enddate' order by ID";  
