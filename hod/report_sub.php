<?php 
 ...
 $query1 = "select attendance from attendance where branch='$branch' and sub_code='$sub_code' and year='$year'  and shift='$shift' and head='TH' order by ID";  
 ...
 $query2 = "select attendance from attendance where branch='$branch' and sub_code='$sub_code'  and year='$year' and  shift='$shift' and head='PR' order by ID";  
