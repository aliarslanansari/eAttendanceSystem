<?php 
 ...
 $query1 = "select attendance from attendance where branch='$branch' and year='$year' and sub_code='$sub_code'  and shift='$shift' and head='TH' and date between '$startdate' and '$enddate' order by ID";
 ...
 $query2 = "select attendance from attendance where branch='$branch' and year='$year' and sub_code='$sub_code' and shift='$shift' and head='PR' and date between '$startdate' and '$enddate' order by ID";  
